        ...
        <ext:FieldContainer runat="server" Layout="HBoxLayout">
            <Items>
                <ext:ComboBox runat="server" ID="cboChucVu" FieldLabel="Chức vụ" EmptyText="Chọn chức vụ quản lý"
                    DisplayField="Ten" ValueField="ID" QueryMode="Local"  LabelStyle="font-weight:bold;" LabelWidth="80" Width="230">
                    <Store>
                ...
                <ext:ComboBox runat="server" ID="cboChucDanh" FieldLabel="Chức danh" EmptyText="Chọn chức danh công việc"
                    DisplayField="Ten" ValueField="ID" QueryMode="Local" LabelStyle="font-weight:bold;" LabelWidth="80" MarginSpec="0 0 0 10" Width="230">
                    <Store>
                ...
                <ext:ComboBox runat="server" ID="cboLinhVucPhuTrach" FieldLabel="Lĩnh vực" EmptyText="Chọn lĩnh vực phụ trách"
                    DisplayField="Ten" ValueField="ID" QueryMode="Local" LabelStyle="font-weight:bold;" LabelWidth="80" MarginSpec="0 0 0 10" Width="250">
                    <Store>
                        <ext:Store runat="server" ID="stoPhuTrach">
                            <Model>
                                <ext:Model runat="server" IDProperty="ID">
                                    <Fields>
                                        <ext:ModelField Name="ID" />

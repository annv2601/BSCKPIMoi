<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCongViecCaNhanNV.aspx.cs" Inherits="BSCKPI.CongViecCaNhan.frmCongViecCaNhanNV" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Menu runat="server" ID="mnuCongViecCaNhan" Width="300">
            <Items>
                ...
                <ext:MenuItem runat="server" ID="mnuitmThemNguoiThucHien" Text="Thêm người phối hợp" Icon="UserAdd" Visible="false">
                    <DirectEvents>
                ...
                <ext:MenuItem runat="server" ID="mnuitemGiaHan" Text="Gia hạn xử lý công việc" Icon="DateGo" Visible="false">
                    <DirectEvents>
                ...
                <ext:MenuItem runat="server" ID="mnuitemDanhGia" Text="Đánh giá kết quả công việc" Icon="ControlEnd" Visible="false">
                    <DirectEvents>

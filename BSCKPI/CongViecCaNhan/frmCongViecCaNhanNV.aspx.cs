    ...
    public partial class frmCongViecCaNhanNV : System.Web.UI.Page
    {
        ...
        private void CheckQuyen(int rIDCN)
        {
            ...
            if (dNDQ.lstQuyen.Count > 0)
            {
                ...
                {
                    btnThemCVMoi.Visible = true;
                }
                else
                {
                    btnThemCVMoi.Visible = false;
                }
            }
            else
            {
            ...
            mnuitmThongTinCVCN.Visible = _Quyen;
            mnuitmThemNguoiThucHien.Visible = _Quyen;
            ...
            mnuitemGiaHan.Visible = _Quyen;
            mnuitemDanhGia.Visible = _Quyen;


            if (dNDQ.lstQuyen[0].IDQuyenTruyNhap == (int)DaoBSCKPI.NguoiDung.daQuyenTruyNhap.eQuyen.Tất_Cả)
            {
                mnuitmThongTinCVCN.Visible = true;

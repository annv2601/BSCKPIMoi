...
namespace DaoBSCKPI.KetQuaDanhGia
{
    public class daBangDanhGia:daThamSo
    {
        ...
        public DataTable BangIn()
        {
            List<clsBangIn> lst;
            lst = lBDG.sp_tblBKMauBangDanhGia_BangIn(Thang, Nam, IDNhanVien).ToList();
            return daDatatableVaList.ToDataTable(lst);
        }
        ...
        public DataTable BangPhanBoIn()
        {
            List<clsBangPhanBo> lst;
            lst = lBDG.sp_tblBKMauBangDanhGia_BangPhanBoIn(Thang, Nam, IDNhanVien).ToList();
            return daDatatableVaList.ToDataTable(lst);
        }

        public DataTable BangPhanBoNhap()
        {
            List<clsBangPhanBo> lst;
            lst = lBDG.sp_tblBKMauBangDanhGia_BangPhanBo(Thang, Nam, IDNhanVien).ToList();
